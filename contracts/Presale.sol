...
contract Presale is Ownable {
    ...
    uint256 public purchasewsOHMAmount; // This is hardcoded to be 0.015 wsOHM
    uint256 public purchaseUSDTAmount; // This is hardcoded to be 
    ...
    function whiteListBuyers(address[] memory _buyers)
        ...
        returns (bool)
    {
        // Considering not adding this line because it gives us flexibility to retroactively WL addresses
