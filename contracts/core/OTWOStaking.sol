...
contract OTWOStaking is Ownable {
    ...
    address public immutable sOTWO;
    ...
    function stake( uint _amount, address _recipient ) external returns ( bool ) {
        ...
        IERC20( OTWO ).safeTransferFrom( msg.sender, address(this), _amount );
        ...
        IERC20( sOTWO ).safeTransfer( warmupContract, _amount );
        return true;
    }
    ...
    function unstake( uint _amount, bool _trigger ) external {
        ...
        IERC20( sOTWO ).safeTransferFrom( msg.sender, address(this), _amount );
        IERC20( OTWO ).safeTransfer( msg.sender, _amount );
    }
    ...
    function contractBalance() public view returns ( uint ) {
        return IERC20( OTWO ).balanceOf( address(this) ).add( totalBonus );
    }
    ...
    function giveLockBonus( uint _amount ) external {
        ...
        IERC20( sOTWO ).safeTransfer( locker, _amount );
    }
    ...
    function returnLockBonus( uint _amount ) external {
        ...
        IERC20( sOTWO ).safeTransferFrom( locker, address(this), _amount );
    }
